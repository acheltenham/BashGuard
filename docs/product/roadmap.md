...
- session start/shutdown Git status snapshots with branch, worktree path, changed-file status, available line counts, and changed line ranges for before/after working-tree comparison;
